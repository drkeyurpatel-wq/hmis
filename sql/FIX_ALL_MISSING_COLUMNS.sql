...
ALTER TABLE IF EXISTS hmis_abdm_consent_requests
  ...
  ADD COLUMN IF NOT EXISTS consent_id VARCHAR(200,
...
ALTER TABLE IF EXISTS hmis_abdm_link_requests
  ...
  ADD COLUMN IF NOT EXISTS link_ref_number VARCHAR(200,
  ADD COLUMN IF NOT EXISTS request_payload JSONB,
  ADD COLUMN IF NOT EXISTS response_payload JSONB;
...
ALTER TABLE IF EXISTS hmis_bed_turnover
  ...
  ADD COLUMN IF NOT EXISTS status VARCHAR(30) DEFAULT 'housekeeping_pending' CHECK (status IN (,
  ADD COLUMN IF NOT EXISTS notes TEXT;
...
ALTER TABLE IF EXISTS hmis_beds
  ...
  ADD COLUMN IF NOT EXISTS current_admission_id uuid, -- FK added after admissions table,
  ADD COLUMN IF NOT EXISTS is_active boolean NOT NULL DEFAULT true;
...
ALTER TABLE IF EXISTS hmis_cathlab_inventory
  ...
  ADD COLUMN IF NOT EXISTS size varchar(50), -- e.g. "3.0 x 38mm",
...
ALTER TABLE IF EXISTS hmis_cathlab_procedures
  ...
  ADD COLUMN IF NOT EXISTS procedure_type varchar(30), -- cag, ptca, ppi, icd, ep_study, bmc, tavi, structural,
  ADD COLUMN IF NOT EXISTS procedure_name varchar(200,
  ADD COLUMN IF NOT EXISTS indication text,
  ADD COLUMN IF NOT EXISTS access_site varchar(20), -- radial, femoral,
  ADD COLUMN IF NOT EXISTS cag_findings text, -- LM, LAD, LCx, RCA findings,
  ADD COLUMN IF NOT EXISTS vessels_involved text[],
  ADD COLUMN IF NOT EXISTS stents_placed jsonb DEFAULT '[]', -- [{vessel, type, brand, size, serial}],
  ADD COLUMN IF NOT EXISTS balloon_used jsonb DEFAULT '[]',
  ADD COLUMN IF NOT EXISTS implant_details jsonb DEFAULT '{}', -- pacemaker/ICD: {brand, model, serial, leads},
  ...
  ADD COLUMN IF NOT EXISTS procedure_status varchar(20) DEFAULT 'scheduled', -- scheduled, in_progress, completed, abandoned, complication,
  ADD COLUMN IF NOT EXISTS outcome varchar(20), -- success, partial, failed,
...
ALTER TABLE IF EXISTS hmis_cdss_overrides
  ADD COLUMN IF NOT EXISTS centre_id uuid,
  ADD COLUMN IF NOT EXISTS patient_id uuid,
  ADD COLUMN IF NOT EXISTS encounter_id uuid,                           -- EMR encounter or admission,
  ADD COLUMN IF NOT EXISTS staff_id uuid,
  ADD COLUMN IF NOT EXISTS alert_type text CHECK (alert_type IN (,
  ADD COLUMN IF NOT EXISTS severity text,
  ADD COLUMN IF NOT EXISTS alert_message text,
  ADD COLUMN IF NOT EXISTS drug_name text,
  ADD COLUMN IF NOT EXISTS interacting_drug text,                          -- for interaction alerts,
  ADD COLUMN IF NOT EXISTS override_reason text,                           -- optional doctor justification;
...
ALTER TABLE IF EXISTS hmis_clinical_alerts
  ...
  ADD COLUMN IF NOT EXISTS source VARCHAR(50), -- 'vitals', 'lab', 'medication', 'cdss', 'nursing', 'manual',
  ...
  ADD COLUMN IF NOT EXISTS auto_resolve_at TIMESTAMPTZ, -- auto-expire after N hours;

-- hmis_consent_audit
ALTER TABLE IF EXISTS hmis_consent_audit
  ADD COLUMN IF NOT EXISTS consent_id UUID ON DELETE CASCADE,
  ADD COLUMN IF NOT EXISTS centre_id UUID,
  ADD COLUMN IF NOT EXISTS action VARCHAR(50) CHECK (action IN (,
  ADD COLUMN IF NOT EXISTS performed_by UUID,
...
ALTER TABLE IF EXISTS hmis_consent_templates
  ...
  ADD COLUMN IF NOT EXISTS consent_type VARCHAR(50) CHECK (consent_type IN (,
  ...
  ADD COLUMN IF NOT EXISTS risks_json jsonb DEFAULT '[]'::jsonb,          -- array of risk strings;
...
ALTER TABLE IF EXISTS hmis_cssd_autoclaves
  ...
  ADD COLUMN IF NOT EXISTS model varchar(100,
  ADD COLUMN IF NOT EXISTS serial_number varchar(100,
  ADD COLUMN IF NOT EXISTS chamber_size varchar(20), -- small, medium, large,
...
ALTER TABLE IF EXISTS hmis_cssd_cycles
  ...
  ADD COLUMN IF NOT EXISTS cycle_type varchar(20), -- gravity, prevacuum, flash, eto,
  ADD COLUMN IF NOT EXISTS load_items jsonb NOT NULL DEFAULT '[]', -- [{set_id, set_name}],
  ADD COLUMN IF NOT EXISTS temperature decimal(5,1,
  ADD COLUMN IF NOT EXISTS pressure decimal(5,2,
  ADD COLUMN IF NOT EXISTS duration_minutes integer,
  ADD COLUMN IF NOT EXISTS bi_test_result varchar(10), -- pass, fail, pending,
  ADD COLUMN IF NOT EXISTS ci_result varchar(10), -- pass, fail,
  ADD COLUMN IF NOT EXISTS operator_id uuid,
  ADD COLUMN IF NOT EXISTS start_time timestamp with time zone,
  ADD COLUMN IF NOT EXISTS end_time timestamp with time zone,
  ADD COLUMN IF NOT EXISTS status varchar(20) DEFAULT 'in_progress', -- in_progress, completed, failed, recalled,
  ADD COLUMN IF NOT EXISTS notes text;
...
ALTER TABLE IF EXISTS hmis_cssd_instrument_sets
  ...
  ADD COLUMN IF NOT EXISTS instruments jsonb NOT NULL DEFAULT '[]', -- [{name, qty, condition}],
  ADD COLUMN IF NOT EXISTS total_instruments integer DEFAULT 0,
  ADD COLUMN IF NOT EXISTS status varchar(20) DEFAULT 'available', -- available, in_use, sterilizing, maintenance,
...
ALTER TABLE IF EXISTS hmis_cssd_issue_return
  ...
  ADD COLUMN IF NOT EXISTS issued_to varchar(100), -- OT/Ward/Department name,
  ...
  ADD COLUMN IF NOT EXISTS condition_on_return varchar(20), -- good, damaged, missing_items,
...
ALTER TABLE IF EXISTS hmis_cssd_quality_checks
  ...
  ADD COLUMN IF NOT EXISTS result varchar(10), -- pass, fail,
...
ALTER TABLE IF EXISTS hmis_cssd_recall_log
  ...
  ADD COLUMN IF NOT EXISTS set_location varchar(100), -- where the set was when recalled,
  ADD COLUMN IF NOT EXISTS patient_affected_id uuid,
  ADD COLUMN IF NOT EXISTS was_used boolean DEFAULT false, -- was the set used on a patient before recall?,
...
ALTER TABLE IF EXISTS hmis_departments
  ...
  ADD COLUMN IF NOT EXISTS name varchar(100),
  ADD COLUMN IF NOT EXISTS type varchar(20),
  ADD COLUMN IF NOT EXISTS hod_staff_id uuid, -- FK added after staff table,
  ADD COLUMN IF NOT EXISTS is_active boolean NOT NULL DEFAULT true;
...
ALTER TABLE IF EXISTS hmis_dialysis_machines
  ...
  ADD COLUMN IF NOT EXISTS model varchar(100,
  ADD COLUMN IF NOT EXISTS serial_number varchar(100,
  ADD COLUMN IF NOT EXISTS status varchar(20) DEFAULT 'available', -- available, in_use, maintenance, out_of_order,
  ADD COLUMN IF NOT EXISTS last_maintenance_date date,
  ADD COLUMN IF NOT EXISTS next_maintenance_date date,
...
ALTER TABLE IF EXISTS hmis_dialysis_monitoring
  ...
  ADD COLUMN IF NOT EXISTS tmp decimal(5,1), -- transmembrane pressure,
  ADD COLUMN IF NOT EXISTS uf_rate decimal(5,1), -- ml/hr,
  ADD COLUMN IF NOT EXISTS uf_removed decimal(6,1), -- cumulative ml,
  ADD COLUMN IF NOT EXISTS access_site_ok boolean DEFAULT true,
...
ALTER TABLE IF EXISTS hmis_dialysis_patients
  ...
  ADD COLUMN IF NOT EXISTS centre_id uuid,
  ADD COLUMN IF NOT EXISTS ckd_stage varchar(10), -- 3a, 3b, 4, 5, 5D,
  ADD COLUMN IF NOT EXISTS etiology varchar(100), -- DM nephropathy, HTN nephropathy, GN, PKD, etc.,
  ...
  ADD COLUMN IF NOT EXISTS access_limb varchar(20), -- left_arm, right_arm, left_leg, right_leg, neck,
  ADD COLUMN IF NOT EXISTS access_details text,
  ADD COLUMN IF NOT EXISTS schedule_pattern varchar(10) DEFAULT 'mwf', -- mwf, tts, daily, custom,
  ADD COLUMN IF NOT EXISTS preferred_shift varchar(10) DEFAULT 'morning', -- morning, afternoon, evening,
...
ALTER TABLE IF EXISTS hmis_dialysis_sessions
  ...
  ADD COLUMN IF NOT EXISTS session_number integer, -- this patient's Nth session,
  ADD COLUMN IF NOT EXISTS dialysis_type varchar(20) DEFAULT 'hd', -- hd, hdf, pd, crrt, sled,
  ADD COLUMN IF NOT EXISTS access_type varchar(20), -- av_fistula, av_graft, catheter_perm, catheter_temp,
  ...
  ADD COLUMN IF NOT EXISTS target_uf decimal(6,1), -- ultrafiltration target in ml,
  ADD COLUMN IF NOT EXISTS dialyzer_type varchar(100,
  ADD COLUMN IF NOT EXISTS blood_flow_rate integer, -- ml/min,
  ...
  ADD COLUMN IF NOT EXISTS complications text[], -- hypotension, cramps, nausea, clotting, access_issue,
...
ALTER TABLE IF EXISTS hmis_dialysis_water_quality
  ...
  ADD COLUMN IF NOT EXISTS test_type varchar(20), -- daily, weekly, monthly, quarterly,
  ADD COLUMN IF NOT EXISTS sample_point varchar(50), -- ro_product, distribution_loop, machine_outlet,
  ...
  ADD COLUMN IF NOT EXISTS bacterial_count int, -- CFU/ml,
  ADD COLUMN IF NOT EXISTS endotoxin decimal(6,2), -- EU/ml,
...
ALTER TABLE IF EXISTS hmis_endoscopy_procedures
  ...
  ADD COLUMN IF NOT EXISTS patient_id uuid,
  ADD COLUMN IF NOT EXISTS procedure_date date DEFAULT CURRENT_DATE,
  ADD COLUMN IF NOT EXISTS procedure_type varchar(30), -- ogd, colonoscopy, ercp, eus, bronchoscopy, sigmoidoscopy,
  ADD COLUMN IF NOT EXISTS indication text,
  ADD COLUMN IF NOT EXISTS sedation_type varchar(20), -- local, conscious, deep, ga,
  ADD COLUMN IF NOT EXISTS scope_id varchar(50), -- track which scope used,
  ADD COLUMN IF NOT EXISTS findings text,
  ADD COLUMN IF NOT EXISTS biopsy_taken boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS biopsy_details text,
  ADD COLUMN IF NOT EXISTS therapeutic_intervention text, -- polypectomy, banding, stenting, dilatation,
  ADD COLUMN IF NOT EXISTS complications text[],
  ...
  ADD COLUMN IF NOT EXISTS images jsonb DEFAULT '[]', -- [{url, description}],
...
ALTER TABLE IF EXISTS hmis_integration_config
  ADD COLUMN IF NOT EXISTS provider text,  -- 'msg91', 'resend', 'razorpay', etc.,
  ADD COLUMN IF NOT EXISTS config_json jsonb NOT NULL DEFAULT '{}'::jsonb,
  ADD COLUMN IF NOT EXISTS is_active boolean DEFAULT true,
  ADD COLUMN IF NOT EXISTS centre_id uuid,  -- NULL = global;
...
ALTER TABLE IF EXISTS hmis_kitchen_production
  ...
  ADD COLUMN IF NOT EXISTS ward_counts jsonb DEFAULT '{}', -- { "ICU": 12, "General Ward": 45, ... },
...
ALTER TABLE IF EXISTS hmis_meal_service
  ...
  ADD COLUMN IF NOT EXISTS patient_id uuid,
  ADD COLUMN IF NOT EXISTS meal_type varchar(20), -- breakfast, lunch, dinner, snack,
  ...
  ADD COLUMN IF NOT EXISTS consumed varchar(20), -- full, partial, refused, npo,
...
ALTER TABLE IF EXISTS hmis_menu_master
  ...
  ADD COLUMN IF NOT EXISTS suitable_for text[] DEFAULT '{}', -- regular, diabetic, renal, cardiac, etc.,
  ADD COLUMN IF NOT EXISTS allergens text[] DEFAULT '{}', -- milk, nuts, gluten, soy, etc.,
  ADD COLUMN IF NOT EXISTS is_active boolean DEFAULT true;
...
ALTER TABLE IF EXISTS hmis_notification_log
  ...
  ADD COLUMN IF NOT EXISTS status text NOT NULL DEFAULT 'pending',
  ADD COLUMN IF NOT EXISTS message_id text,        -- WhatsApp message ID from Meta API,
  ADD COLUMN IF NOT EXISTS error_message text;
...
ALTER TABLE IF EXISTS hmis_notification_preferences
  ...
  ADD COLUMN IF NOT EXISTS template_text text,  -- optional custom template override;
...
ALTER TABLE IF EXISTS hmis_package_utilization
  ...
  ADD COLUMN IF NOT EXISTS rate_type varchar(20) DEFAULT 'self', -- self, insurance, pmjay, cghs, esi, corporate,
  ...
  ADD COLUMN IF NOT EXISTS variance decimal(12,2) DEFAULT 0, -- positive = hospital profit, negative = loss,
...
ALTER TABLE IF EXISTS hmis_patient_consents
  ...
  ADD COLUMN IF NOT EXISTS consent_html text,                  -- snapshot of template at sign time,
  ADD COLUMN IF NOT EXISTS risks_explained text,
  ADD COLUMN IF NOT EXISTS signature_data text,                  -- base64 PNG from canvas,
  ...
  ADD COLUMN IF NOT EXISTS witness_signature text,                  -- base64 PNG,
  ADD COLUMN IF NOT EXISTS doctor_signature text,                  -- base64 PNG,
...
ALTER TABLE IF EXISTS hmis_patients
  ...
  ADD COLUMN IF NOT EXISTS id_number varchar(30), -- Consider pgcrypto encryption for production,
...
ALTER TABLE IF EXISTS hmis_physio_fms
  ...
  ADD COLUMN IF NOT EXISTS risk_level varchar(10), -- low, moderate, high,
  ADD COLUMN IF NOT EXISTS notes text;
...
ALTER TABLE IF EXISTS hmis_physio_outcomes
  ...
  ADD COLUMN IF NOT EXISTS measure_type varchar(30), -- vas, koos, dash, lefs, sf36, oswestry, nprs, groc, fms, y_balance, hop_test, berg_balance,
  ADD COLUMN IF NOT EXISTS score decimal(6,1),
  ADD COLUMN IF NOT EXISTS max_score decimal(6,1,
  ADD COLUMN IF NOT EXISTS subscales jsonb DEFAULT '{}', -- { pain: 45, symptoms: 60, adl: 55, sport: 30, qol: 25 } for KOOS,
  ADD COLUMN IF NOT EXISTS notes text,
  ADD COLUMN IF NOT EXISTS recorded_by uuid;
...
ALTER TABLE IF EXISTS hmis_physio_plans
  ...
  ADD COLUMN IF NOT EXISTS frequency varchar(30), -- daily, alternate, twice_week, weekly,
  ADD COLUMN IF NOT EXISTS status varchar(20) DEFAULT 'active', -- active, completed, discontinued,
...
ALTER TABLE IF EXISTS hmis_physio_prevention_programs
  ...
  ADD COLUMN IF NOT EXISTS program_type varchar(30), -- injury_prevention, prehab, wellness, corporate, sports_specific,
  ADD COLUMN IF NOT EXISTS target_population varchar(100), -- cricket_fast_bowlers, runners, desk_workers, elderly, post_menopausal,
...
ALTER TABLE IF EXISTS hmis_physio_sessions
  ...
  ADD COLUMN IF NOT EXISTS diagnosis varchar(200,
  ADD COLUMN IF NOT EXISTS treatment_area varchar(100), -- knee, shoulder, spine, neuro, cardiac, chest,
  ADD COLUMN IF NOT EXISTS modalities text[], -- ift, tens, us, swd, laser, wax, traction, cpm,
  ADD COLUMN IF NOT EXISTS exercises text[],
  ADD COLUMN IF NOT EXISTS manual_therapy text,
  ADD COLUMN IF NOT EXISTS pain_score_before integer, -- 0-10 VAS,
  ADD COLUMN IF NOT EXISTS pain_score_after integer,
  ADD COLUMN IF NOT EXISTS rom_before jsonb DEFAULT '{}', -- {flexion: 90, extension: 0},
  ADD COLUMN IF NOT EXISTS rom_after jsonb DEFAULT '{}',
  ADD COLUMN IF NOT EXISTS functional_score integer, -- standardized outcome measure,
  ADD COLUMN IF NOT EXISTS duration_minutes integer DEFAULT 30,
  ADD COLUMN IF NOT EXISTS status varchar(20) DEFAULT 'scheduled', -- scheduled, in_progress, completed, cancelled, no_show,
  ADD COLUMN IF NOT EXISTS billing_done boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS notes text,
...
ALTER TABLE IF EXISTS hmis_pmjay_packages
  ...
  ADD COLUMN IF NOT EXISTS procedure_name text,
  ADD COLUMN IF NOT EXISTS base_rate decimal(12,2),          -- Tier3 (Z) base rate,
  ADD COLUMN IF NOT EXISTS nabh_incentive decimal(12,2),     -- 10% of base_rate,
  ADD COLUMN IF NOT EXISTS effective_rate decimal(12,2),      -- base + incentive,
  ADD COLUMN IF NOT EXISTS implant_name text,
  ADD COLUMN IF NOT EXISTS implant_cost decimal(12,2) DEFAULT 0,
  ADD COLUMN IF NOT EXISTS total_with_implant decimal(12,2),  -- effective_rate + implant_cost,
  ADD COLUMN IF NOT EXISTS level_of_care varchar(20,
  ADD COLUMN IF NOT EXISTS alos int,                                   -- Average Length of Stay,
...
ALTER TABLE IF EXISTS hmis_px_activity_log
  ...
  ADD COLUMN IF NOT EXISTS centre_id UUID,
  ADD COLUMN IF NOT EXISTS patient_id UUID,
  ADD COLUMN IF NOT EXISTS reference_id UUID, -- FK to the relevant table row,
  ADD COLUMN IF NOT EXISTS details JSONB DEFAULT '{}',
  ADD COLUMN IF NOT EXISTS performed_by VARCHAR(50), -- 'patient' or staff UUID;
...
ALTER TABLE IF EXISTS hmis_px_complaints
  ...
  ADD COLUMN IF NOT EXISTS description TEXT,
  ADD COLUMN IF NOT EXISTS photo_url TEXT,
  ADD COLUMN IF NOT EXISTS priority VARCHAR(10) NOT NULL DEFAULT 'normal', -- normal, high,
  ADD COLUMN IF NOT EXISTS assigned_to UUID,
  ADD COLUMN IF NOT EXISTS assigned_at TIMESTAMPTZ,
  ADD COLUMN IF NOT EXISTS resolution_notes TEXT,
  ADD COLUMN IF NOT EXISTS resolved_at TIMESTAMPTZ,
  ADD COLUMN IF NOT EXISTS closed_at TIMESTAMPTZ,
  ADD COLUMN IF NOT EXISTS sla_hours INT NOT NULL DEFAULT 24, -- target resolution time;

-- hmis_px_feedback
ALTER TABLE IF EXISTS hmis_px_feedback
  ADD COLUMN IF NOT EXISTS token_id UUID, -- nullable for post-discharge feedback,
  ADD COLUMN IF NOT EXISTS patient_id UUID,
  ADD COLUMN IF NOT EXISTS centre_id UUID,
  ADD COLUMN IF NOT EXISTS admission_id UUID,
  ADD COLUMN IF NOT EXISTS patient_name VARCHAR(200,
  ...
  ADD COLUMN IF NOT EXISTS is_public BOOLEAN NOT NULL DEFAULT false, -- patient consents to share,
  ADD COLUMN IF NOT EXISTS google_review_status VARCHAR(20) DEFAULT 'none', -- none, prompted, submitted, verified,
...
ALTER TABLE IF EXISTS hmis_px_food_menu
  ...
  ADD COLUMN IF NOT EXISTS category VARCHAR(50), -- breakfast, lunch, dinner, snacks, beverages,
  ADD COLUMN IF NOT EXISTS description TEXT,
  ADD COLUMN IF NOT EXISTS price NUMERIC(8,2) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS dietary_tags TEXT[] DEFAULT '{}', -- veg, non-veg, jain, diabetic-friendly, low-sodium, liquid-diet,
  ADD COLUMN IF NOT EXISTS image_url TEXT,
  ADD COLUMN IF NOT EXISTS is_available BOOLEAN NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS available_from TIME, -- e.g. 07:00 for breakfast,
  ADD COLUMN IF NOT EXISTS available_until TIME, -- e.g. 10:00,
...
ALTER TABLE IF EXISTS hmis_px_food_orders
  ...
  ADD COLUMN IF NOT EXISTS centre_id UUID,
  ADD COLUMN IF NOT EXISTS admission_id UUID,
  ADD COLUMN IF NOT EXISTS bed_label VARCHAR(50), -- denormalized for kitchen display: "ICU-101",
  ADD COLUMN IF NOT EXISTS ward_name VARCHAR(100), -- denormalized: "ICU",
  ADD COLUMN IF NOT EXISTS patient_name VARCHAR(200), -- denormalized for kitchen display,
  ADD COLUMN IF NOT EXISTS items JSONB NOT NULL DEFAULT '[]',
  ...
  ADD COLUMN IF NOT EXISTS dietary_restrictions TEXT, -- from patient's admission record,
...
ALTER TABLE IF EXISTS hmis_px_nurse_calls
  ...
  ADD COLUMN IF NOT EXISTS completed_at TIMESTAMPTZ,
  ADD COLUMN IF NOT EXISTS response_seconds INT, -- time from creation to acknowledged,
  ADD COLUMN IF NOT EXISTS resolution_seconds INT, -- time from creation to completed;
...
ALTER TABLE IF EXISTS hmis_referrals
  ADD COLUMN IF NOT EXISTS centre_id uuid,
  ADD COLUMN IF NOT EXISTS patient_id uuid,
  ADD COLUMN IF NOT EXISTS referral_type varchar(20), -- internal, external_in, external_out,
  ADD COLUMN IF NOT EXISTS referring_doctor_name varchar(200,
  ADD COLUMN IF NOT EXISTS referring_doctor_phone varchar(20,
  ADD COLUMN IF NOT EXISTS referring_doctor_reg varchar(50), -- MCI/state reg number,
  ...
  ADD COLUMN IF NOT EXISTS reason text,
  ADD COLUMN IF NOT EXISTS diagnosis varchar(200,
  ADD COLUMN IF NOT EXISTS urgency varchar(10) DEFAULT 'routine', -- emergency, urgent, routine,
  ADD COLUMN IF NOT EXISTS status varchar(20) DEFAULT 'received', -- received, appointment_made, visited, admitted, completed, lost,
...
ALTER TABLE IF EXISTS hmis_report_subscriptions
  ...
  ADD COLUMN IF NOT EXISTS report_type text NOT NULL DEFAULT 'daily_summary' CHECK (report_type IN (,
...
ALTER TABLE IF EXISTS hmis_revenue_rules
  ...
  ADD COLUMN IF NOT EXISTS rule_type varchar(30), -- unbilled_charge, missing_room, unbilled_procedure, unbilled_pharmacy, unbilled_lab, unpaid_bill, package_overstay, missing_consult, missing_nursing,
  ADD COLUMN IF NOT EXISTS severity varchar(10) DEFAULT 'high',
  ADD COLUMN IF NOT EXISTS condition_sql text, -- optional: custom SQL condition,
  ADD COLUMN IF NOT EXISTS threshold_amount decimal(12,2) DEFAULT 0,
  ADD COLUMN IF NOT EXISTS threshold_days int DEFAULT 0,
  ADD COLUMN IF NOT EXISTS is_active boolean DEFAULT true,
  ADD COLUMN IF NOT EXISTS auto_flag boolean DEFAULT true, -- auto-flag or manual review;
...
ALTER TABLE IF EXISTS hmis_scope_decontamination
  ...
  ADD COLUMN IF NOT EXISTS scope_type varchar(30), -- gastroscope, colonoscope, duodenoscope, bronchoscope,
  ADD COLUMN IF NOT EXISTS procedure_id uuid,
  ADD COLUMN IF NOT EXISTS decontamination_method varchar(30), -- aer, manual, cidex,
  ADD COLUMN IF NOT EXISTS start_time timestamp with time zone,
  ADD COLUMN IF NOT EXISTS end_time timestamp with time zone,
  ADD COLUMN IF NOT EXISTS leak_test varchar(10), -- pass, fail,
  ADD COLUMN IF NOT EXISTS culture_result varchar(20), -- pending, negative, positive,
  ADD COLUMN IF NOT EXISTS performed_by uuid,
...
ALTER TABLE IF EXISTS hmis_shift_handovers
  ...
  ADD COLUMN IF NOT EXISTS census jsonb DEFAULT '{}', -- { total: 45, icu: 12, new_admissions: 3, discharges: 2, deaths: 0, transfers_in: 1, transfers_out: 0 },
  ADD COLUMN IF NOT EXISTS critical_patients jsonb DEFAULT '[]', -- [{ patient_id, name, bed, diagnosis, news2, concern, plan }],
...
ALTER TABLE IF EXISTS hmis_surgical_checklist_items
  ...
  ADD COLUMN IF NOT EXISTS lab_order_id UUID,        -- links to hmis_lab_orders,
  ADD COLUMN IF NOT EXISTS pre_auth_id UUID,         -- links to hmis_pre_auth_requests,
  ADD COLUMN IF NOT EXISTS consent_id UUID,          -- links to hmis_consents,
  ADD COLUMN IF NOT EXISTS cssd_issue_id UUID,       -- links to hmis_cssd_issue_return,
  ADD COLUMN IF NOT EXISTS bed_id UUID,              -- links to hmis_beds,
  ADD COLUMN IF NOT EXISTS completed_by UUID,
  ADD COLUMN IF NOT EXISTS completed_at TIMESTAMPTZ,
  ADD COLUMN IF NOT EXISTS sort_order INT DEFAULT 0;
...
ALTER TABLE IF EXISTS hmis_voice_notes
  ADD COLUMN IF NOT EXISTS centre_id uuid,
  ADD COLUMN IF NOT EXISTS patient_id uuid,
  ADD COLUMN IF NOT EXISTS encounter_id uuid, -- opd visit or admission,
  ADD COLUMN IF NOT EXISTS encounter_type varchar(10) DEFAULT 'opd', -- opd, ipd,
  ADD COLUMN IF NOT EXISTS recorded_by uuid,
