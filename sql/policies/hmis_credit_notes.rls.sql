-- =============================================================================
-- RLS policies for hmis_credit_notes
-- =============================================================================
-- Applied on production (bmuupgrzbfmddjwcqlss) as migration: phase1_05_harden_credit_notes
...
ALTER TABLE hmis_credit_notes ENABLE ROW LEVEL SECURITY;

-- Drop legacy weak policies replaced by this file
DROP POLICY IF EXISTS "hmis_credit_notes_pol_auth" ON hmis_credit_notes;

-- Current (strong) policies
DROP POLICY IF EXISTS "hmis_credit_notes_auth" ON hmis_credit_notes;

CREATE POLICY "hmis_credit_notes_auth" ON hmis_credit_notes
...
-- -- ALTER TABLE hmis_credit_notes DISABLE ROW LEVEL SECURITY;
-- -- DROP POLICY IF EXISTS "hmis_credit_notes_auth" ON hmis_credit_notes;
