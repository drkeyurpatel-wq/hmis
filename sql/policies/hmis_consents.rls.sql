-- =============================================================================
-- RLS policies for hmis_consents
-- =============================================================================
-- Applied on production (bmuupgrzbfmddjwcqlss) as migration: phase1_04_harden_consents
...
DROP POLICY IF EXISTS "hmis_consents_pol_auth" ON hmis_consents;

-- Current (strong) policies
DROP POLICY IF EXISTS "hmis_consents_auth" ON hmis_consents;

CREATE POLICY "hmis_consents_auth" ON hmis_consents
...
-- -- ALTER TABLE hmis_consents DISABLE ROW LEVEL SECURITY;
-- -- DROP POLICY IF EXISTS "hmis_consents_auth" ON hmis_consents;
