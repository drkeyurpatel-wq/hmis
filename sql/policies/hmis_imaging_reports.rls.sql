-- =============================================================================
-- RLS policies for hmis_imaging_reports
-- =============================================================================
-- Applied on production (bmuupgrzbfmddjwcqlss) as migration: phase1_08_harden_imaging_reports
...
ALTER TABLE hmis_imaging_reports ENABLE ROW LEVEL SECURITY;

-- Drop legacy weak policies replaced by this file
DROP POLICY IF EXISTS "hmis_imaging_reports_pol" ON hmis_imaging_reports;

-- Current (strong) policies
DROP POLICY IF EXISTS "hmis_imaging_reports_auth" ON hmis_imaging_reports;

CREATE POLICY "hmis_imaging_reports_auth" ON hmis_imaging_reports
...
-- -- ALTER TABLE hmis_imaging_reports DISABLE ROW LEVEL SECURITY;
-- -- DROP POLICY IF EXISTS "hmis_imaging_reports_auth" ON hmis_imaging_reports;
