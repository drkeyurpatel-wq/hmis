-- =============================================================================
-- RLS policies for hmis_appointments
-- =============================================================================
-- Applied on production (bmuupgrzbfmddjwcqlss) as migration: phase1_02_harden_appointments
...
ALTER TABLE hmis_appointments ENABLE ROW LEVEL SECURITY;

-- Drop legacy weak policies replaced by this file
DROP POLICY IF EXISTS "hmis_appointments_pol" ON hmis_appointments;

-- Current (strong) policies
DROP POLICY IF EXISTS "hmis_appointments_auth" ON hmis_appointments;

CREATE POLICY "hmis_appointments_auth" ON hmis_appointments
...
-- -- ALTER TABLE hmis_appointments DISABLE ROW LEVEL SECURITY;
-- -- DROP POLICY IF EXISTS "hmis_appointments_auth" ON hmis_appointments;
