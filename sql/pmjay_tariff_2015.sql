...
-- Source: HBP_2022_for_Tender_PS_11_17122025.Xlsx (Procedure Master)
-- Shilaj = NABH accredited → 10% incentive on PACKAGE price (not implant)
-- rate_self = package + 10% NABH + implant (total Shilaj gets)
-- rate_insurance = same as rate_self
-- rate_pmjay = base Tier3 package (without NABH incentive or implant)
-- rate_cghs = base Tier3 package
...
retrieval', 'pmjay_ent', 220000, 220000, 200000, 200000),
  ...
  ('PMJAY-IN016A', 'Lymphatic occlusion of chylous leak', 'pmjay_ent', 31330, 31330, 21300, 21300),
  ...
  ('PMJAY-IN018A', 'Glue embolization (without microcatheter)', 'pmjay_ent', 41300, 41300, 25000, 25000),
  ('PMJAY-IN018B', 'Glue embolization (with microcatheter)', 'pmjay_ent', 35400, 35400, 25000, 25000),
  ...
  ('PMJAY-IN022A', 'Vascular plug assisted embolization', 'pmjay_ent', 61910, 61910, 49100, 49100),
  ...
  ('PMJAY-IN024A', 'Catheter directed thrombolysis (arterial/venous)', 'pmjay_ent', 58310, 58310, 44100, 44100),
  ...
  ('PMJAY-IN031A', 'Fenestration of dissecting aneurysm', 'pmjay_ent', 980078030, 980078030, 37300, 37300),
  ...
  ('PMJAY-IN061B', 'Transarterial chemoembolization - Drug eluting beads (DEB-TACE)', 'pmjay_ent', 52000, 52000, 30000, 30000),
  ('PMJAY-IN062A', 'Transjugular intrahepatic portosystemic shunt creation (TIPSS)/Direct transjugular Intrahepatic Portosystemic shunt(DIPSS)', 'pmjay_ent', 141170, 141170, 94700, 94700),
  ('PMJAY-IN063A', 'Balloon-occluded retrograde transvenous obliteration (BRTO)', 'pmjay_ent', 64000, 64000, 51000, 51000),
  ('PMJAY-IN064A', 'Plug-assisted retrograde transvenous obliteration (PARTO)', 'pmjay_ent', 81360, 81360, 57600, 57600),
  ('PMJAY-IN065A', 'Pre-operative portal vein embolization', 'pmjay_ent', 44640, 44640, 33400, 33400),
  ...
  ('PMJAY-IN069A', 'Kyphoplasty', 'pmjay_ent', 62170, 62170, 39700, 39700),
  ...
  ('PMJAY-IN075A', 'Varicocele embolization', 'pmjay_ent', 42970, 42970, 22700, 22700),
  ...
  ('PMJAY-MC010A', 'PDA stenting', 'pmjay_cardiology', 57146, 57146, 50400, 50400),
...
(includes supportive care and investigations)', 'pmjay_transplant', 68750, 68750, 62500, 62500),
  ...
  ('PMJAY-SB005A', 'External fixation of Fracture-Long bone', 'pmjay_ortho', 22400, 22400, 14000, 14000),
  ...
  ('PMJAY-SB009A', 'Fracture - Long Bones - Metaphyseal - ORIF', 'pmjay_ortho', 19040, 19040, 16400, 16400),
  ...
  ('PMJAY-SB012A', 'Fracture Head radius-Fixation', 'pmjay_ortho', 13500, 13500, 10000, 10000),
  ('PMJAY-SB012B', 'Fracture Head radius-Excision', 'pmjay_ortho', 10120, 10120, 9200, 9200),
  ('PMJAY-SB013A', 'Fracture - Single Bone - Forearm - ORIF - Plating / Nailing/DCP/LCP', 'pmjay_ortho', 12290, 12290, 8900, 8900),
  ('PMJAY-SB014A', 'Fracture - Both Bones - Forearm - ORIF - Plating / Nailing /DCP/LCP', 'pmjay_ortho', 19710, 19710, 16100, 16100),
  ...
  ('PMJAY-SB020A', 'ORIF of medial malleolus or bimalleolar fracture or Trimalleolar fracture', 'pmjay_ortho', 18160, 18160, 15600, 15600),
  ('PMJAY-SB021A', 'Cervical spine fixation including odontoid', 'pmjay_ortho', 39370, 39370, 26700, 26700),
  ...
  ('PMJAY-SB036A', 'Arthroscopic Meniscus Repair / Meniscectomy', 'pmjay_ortho', 14200, 14200, 12000, 12000),
...
(depending upon type of joint and', 'pmjay_ortho', 189430, 189430, 81300, 81300),
  ...
  ('PMJAY-SB049A', 'Reconstruction of Cruciate Ligament with implant and brace-Anterior', 'pmjay_ortho', 37420, 37420, 32200, 32200),
  ...
  ('PMJAY-SB055A', 'Osteotomy-Long Bone', 'pmjay_ortho', 25800, 25800, 18000, 18000),
...
(3 sittings per eye for both eyes)', 'pmjay_ophthalmology', 9350, 9350, 8500, 8500),
  ...
  ('PMJAY-SG050E', 'Groin Hernia Repair Obturator - Lap.', 'pmjay_gen_surgery', 27190, 27190, 22900, 22900),
  ...
  ('PMJAY-SG052A', 'Repair of Incisional Hernia Lap/Open', 'pmjay_gen_surgery', 24330, 24330, 20300, 20300),
  ...
  ('PMJAY-SG103A', 'ERCP + Stenting/Stone removal', 'pmjay_gen_surgery', 35500, 35500, 25000, 25000),
...
Startification', 'pmjay_urology', 27500, 27500, 25000, 25000),
  ...
  ('PMJAY-SV002A', 'ASD closure + Partial Anomalous Venous Drainage Repair', 'pmjay_ctvs', 211500, 211500, 165000, 165000),
  ('PMJAY-SV002B', 'ASD Closure + Mitral procedure', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002C', 'ASD Closure + Tricuspid procedure', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002D', 'ASD Closure + Pulmonary procedure', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002E', 'ASD Closure + Infundibular procedure', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002F', 'VSD closure', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002G', 'Infundibular PS repair', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002H', 'Valvular PS / PR repair', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002I', 'Partial AV canal repair', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002J', 'Intermediate AV canal repair', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002K', 'Atrial septectomy + Glenn', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002L', 'Atrial septectomy + PA Band', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002M', 'Sinus of Valsalva aneurysm repair with aortic valve procedure', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002N', 'Sinus of Valsalva aneurysm repair without aortic valve procedure', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV002O', 'Sub-aortic membrane resection', 'pmjay_ctvs', 216500, 216500, 165000, 165000),
  ('PMJAY-SV003A', 'Ebstien anomoly repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003B', 'Double switch operation', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003C', 'Rastelli Procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003D', 'Fontan procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003E', 'AP window repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003F', 'Arch interruption Repair without VSD closure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003G', 'Arch interruption Repair with VSD closure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003H', 'DORV Repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003I', 'Supravalvular AS repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003J', 'Konno procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003K', 'Norwood procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003L', 'VSD closure + RV - PA conduit', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003M', 'VSD + Aortic procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003N', 'VSD + Mitral procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003O', 'VSD + Tricuspid procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003P', 'VSD + Pulmonary artery procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003Q', 'VSD + Infundibular procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003R', 'VSD + Coarctation repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003S', 'TAPVC Repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003T', 'Truncus arteriosus repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003U', 'Tetralogy of Fallot Repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003V', 'Complete AV canal repair', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003W', 'Arterial switch operation', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003X', 'Senning Operation', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV003Y', 'Mustard Operation', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ...
  ('PMJAY-SV005B', 'Mitral valve replacement / Mitral valve repair', 'pmjay_ctvs', 215070, 215070, 163700, 163700),
  ('PMJAY-SV005C', 'Tricuspid valve replacement / Tricuspid valve repair', 'pmjay_ctvs', 215070, 215070, 163700, 163700),
  ('PMJAY-SV006A', 'Double valve replacement / repair', 'pmjay_ctvs', 249830, 249830, 195300, 195300),
  ('PMJAY-SV007A', 'Triple valve replacement / repair', 'pmjay_ctvs', 292180, 292180, 233800, 233800),
  ...
  ('PMJAY-SV010A', 'Surgery for Hypertrophic Obstructive Cardiomyopathy (HOCM)', 'pmjay_ctvs', 202970, 202970, 152700, 152700),
  ...
  ('PMJAY-SV014A', 'Bental Procedure', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV014B', 'Aortic Dissection', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV014C', 'Aortic Aneurysm ( Root Ascending )', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV014D', 'Valve sparing root replacement', 'pmjay_ctvs', 306930, 306930, 206300, 206300),
  ('PMJAY-SV014E', 'AVR + Root enlargement', 'pmjay_ctvs', 276930, 276930, 206300, 206300),
  ...
  ('PMJAY-SV031A', 'Tetralogy of Fallot Repair (immediate  re operation)', 'pmjay_ctvs', 193520, 193520, 103200, 103200),
  ('PMJAY-SV031B', 'Aortic valve replacement /repair', 'pmjay_ctvs', 295710, 295710, 196100, 196100),
  ('PMJAY-SV031C', 'Mitral valve replacement /repair', 'pmjay_ctvs', 250710, 250710, 196100, 196100),
  ('PMJAY-SV031D', 'Tricuspid valve replacement /repair', 'pmjay_ctvs', 250710, 250710, 196100, 196100),
  ('PMJAY-SV031E', 'Double valve replacement /repair', 'pmjay_ctvs', 142470, 142470, 97700, 97700),
  ('PMJAY-SV031F', 'Triple valve replacement /repair', 'pmjay_ctvs', 163590, 163590, 116900, 116900),
