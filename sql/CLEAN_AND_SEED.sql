-- CLEANUP (safe — deletes in FK order)
DELETE FROM hmis_er_visits;
DELETE FROM hmis_pharmacy_dispensing;
DELETE FROM hmis_radiology_orders;
DELETE FROM hmis_lab_orders;
DELETE FROM hmis_orders;
DELETE FROM hmis_payments;
DELETE FROM hmis_bills;
DELETE FROM hmis_charge_log;
DELETE FROM hmis_emr_encounters;
DELETE FROM hmis_opd_visits;
DELETE FROM hmis_vitals;
UPDATE hmis_beds SET status='available', current_admission_id=NULL;
DELETE FROM hmis_admissions;
DELETE FROM hmis_patients;
DELETE FROM hmis_staff_centres WHERE staff_id IN (SELECT id FROM hmis_staff WHERE employee_code LIKE 'H1-DOC-%' OR employee_code LIKE 'H1-STF-%');
DELETE FROM hmis_staff WHERE employee_code LIKE 'H1-DOC-%' OR employee_code LIKE 'H1-STF-%';
DELETE FROM hmis_beds;
DELETE FROM hmis_rooms;
DELETE FROM hmis_wards;
DELETE FROM hmis_radiology_test_master;
DELETE FROM hmis_lab_test_master;
