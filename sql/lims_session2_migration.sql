...
-- ============================================================
INSERT INTO hmis_lab_test_master (test_code, test_name, department, category, sample_type, tat_routine_hrs, tat_urgent_hrs, rate_self, rate_panel, is_active) VALUES
-- Biochemistry
('PPBS', 'Post Prandial Blood Sugar', 'Biochemistry', 'Glucose', 'serum', 2, 0.5, 100, 80, true),
('RBS', 'Random Blood Sugar', 'Biochemistry', 'Glucose', 'serum', 1, 0.25, 100, 80, true),
('GTT', 'Glucose Tolerance Test', 'Biochemistry', 'Glucose', 'serum', 6, 3, 400, 350, true),
('AMYLASE', 'Serum Amylase', 'Biochemistry', 'Enzyme', 'serum', 4, 1, 250, 200, true),
('LIPASE', 'Serum Lipase', 'Biochemistry', 'Enzyme', 'serum', 4, 1, 300, 250, true),
('CK_MB', 'CK-MB', 'Biochemistry', 'Cardiac', 'serum', 2, 0.5, 400, 350, true),
('TROP_I', 'Troponin I', 'Biochemistry', 'Cardiac', 'serum', 1, 0.25, 600, 500, true),
('TROP_T', 'Troponin T', 'Biochemistry', 'Cardiac', 'serum', 1, 0.25, 600, 500, true),
('BNP', 'NT-proBNP', 'Biochemistry', 'Cardiac', 'serum', 4, 1, 1500, 1200, true),
('CRP', 'C-Reactive Protein (Quantitative)', 'Biochemistry', 'Inflammatory', 'serum', 4, 1, 400, 350, true),
('PROCALC', 'Procalcitonin', 'Biochemistry', 'Inflammatory', 'serum', 4, 1, 1200, 1000, true),
('FERRITIN', 'Serum Ferritin', 'Biochemistry', 'Iron', 'serum', 6, 2, 400, 350, true),
('IRON', 'Serum Iron', 'Biochemistry', 'Iron', 'serum', 4, 1, 200, 150, true),
('TIBC', 'TIBC', 'Biochemistry', 'Iron', 'serum', 4, 1, 250, 200, true),
('VIT_D', 'Vitamin D (25-OH)', 'Biochemistry', 'Vitamins', 'serum', 24, 6, 800, 700, true),
('VIT_B12', 'Vitamin B12', 'Biochemistry', 'Vitamins', 'serum', 24, 6, 600, 500, true),
('FOLATE', 'Folic Acid', 'Biochemistry', 'Vitamins', 'serum', 24, 6, 500, 400, true),
('LDH', 'Lactate Dehydrogenase', 'Biochemistry', 'Enzyme', 'serum', 4, 1, 250, 200, true),
('MAGNESIUM', 'Serum Magnesium', 'Biochemistry', 'Electrolyte', 'serum', 4, 1, 200, 150, true),
('LACTATE', 'Blood Lactate', 'Biochemistry', 'Metabolic', 'plasma', 1, 0.25, 300, 250, true),
('AMMONIA', 'Blood Ammonia', 'Biochemistry', 'Metabolic', 'plasma', 2, 0.5, 400, 350, true),
('PT_INR', 'PT / INR', 'Hematology', 'Coagulation', 'plasma', 2, 0.5, 250, 200, true),
('APTT', 'aPTT', 'Hematology', 'Coagulation', 'plasma', 2, 0.5, 250, 200, true),
('DDIMER', 'D-Dimer', 'Hematology', 'Coagulation', 'plasma', 2, 0.5, 600, 500, true),
('FIBRINOGEN', 'Fibrinogen', 'Hematology', 'Coagulation', 'plasma', 4, 1, 400, 350, true),
('RETIC', 'Reticulocyte Count', 'Hematology', 'Cell Count', 'blood', 4, 1, 200, 150, true),
('PBS', 'Peripheral Blood Smear', 'Hematology', 'Morphology', 'blood', 4, 1, 150, 120, true),
-- Endocrinology
('FT3', 'Free T3', 'Endocrinology', 'Thyroid', 'serum', 6, 2, 300, 250, true),
('FT4', 'Free T4', 'Endocrinology', 'Thyroid', 'serum', 6, 2, 300, 250, true),
('CORTISOL', 'Serum Cortisol', 'Endocrinology', 'Adrenal', 'serum', 24, 6, 500, 400, true),
('INSULIN', 'Fasting Insulin', 'Endocrinology', 'Glucose', 'serum', 24, 6, 400, 350, true),
('PSA', 'PSA (Total)', 'Endocrinology', 'Tumor Marker', 'serum', 24, 6, 500, 400, true),
('CEA', 'CEA', 'Endocrinology', 'Tumor Marker', 'serum', 24, 6, 500, 400, true),
('AFP', 'Alpha Fetoprotein', 'Endocrinology', 'Tumor Marker', 'serum', 24, 6, 500, 400, true),
('CA125', 'CA-125', 'Endocrinology', 'Tumor Marker', 'serum', 24, 6, 700, 600, true),
('CA199', 'CA 19-9', 'Endocrinology', 'Tumor Marker', 'serum', 24, 6, 700, 600, true),
-- Urine
('URINE_RM', 'Urine Routine & Microscopy', 'Biochemistry', 'Urine', 'urine', 2, 0.5, 100, 80, true),
('URINE_CS', 'Urine Culture & Sensitivity', 'Microbiology', 'Culture', 'urine', 48, 24, 500, 400, true),
('MICRO_ALBUMIN', 'Urine Microalbumin', 'Biochemistry', 'Urine', 'urine', 4, 1, 400, 350, true),
('ACR', 'Albumin-Creatinine Ratio', 'Biochemistry', 'Urine', 'urine', 4, 1, 500, 400, true),
('UPE', 'Urine Protein (24hr)', 'Biochemistry', 'Urine', 'urine', 24, 6, 300, 250, true),
-- Microbiology
('BLOOD_CS', 'Blood Culture & Sensitivity', 'Microbiology', 'Culture', 'blood', 72, 48, 800, 700, true),
('SPUTUM_CS', 'Sputum Culture & Sensitivity', 'Microbiology', 'Culture', 'sputum', 72, 48, 500, 400, true),
('WOUND_CS', 'Wound Swab Culture & Sensitivity', 'Microbiology', 'Culture', 'swab', 72, 48, 500, 400, true),
('CSF_CS', 'CSF Culture & Sensitivity', 'Microbiology', 'Culture', 'csf', 72, 48, 800, 700, true),
('STOOL_CS', 'Stool Culture & Sensitivity', 'Microbiology', 'Culture', 'stool', 72, 48, 500, 400, true),
('FLUID_CS', 'Body Fluid Culture & Sensitivity', 'Microbiology', 'Culture', 'fluid', 72, 48, 600, 500, true),
('AFB_SMEAR', 'AFB Smear (ZN Stain)', 'Microbiology', 'TB', 'sputum', 4, 1, 150, 120, true),
('AFB_CULTURE', 'AFB Culture (MGIT)', 'Microbiology', 'TB', 'sputum', 1008, 672, 800, 700, true),
('MALARIA', 'Malaria Parasite (Smear)', 'Microbiology', 'Parasite', 'blood', 2, 0.5, 100, 80, true),
('DENGUE_NS1', 'Dengue NS1 Antigen', 'Microbiology', 'Serology', 'serum', 4, 1, 500, 400, true),
('DENGUE_IGM', 'Dengue IgM', 'Microbiology', 'Serology', 'serum', 4, 1, 400, 350, true),
('WIDAL', 'Widal Test', 'Microbiology', 'Serology', 'serum', 4, 1, 200, 150, true),
('HBsAg', 'HBsAg', 'Microbiology', 'Serology', 'serum', 4, 1, 200, 150, true),
('HCV', 'Anti-HCV', 'Microbiology', 'Serology', 'serum', 4, 1, 300, 250, true),
('HIV', 'HIV 1&2 Antibody', 'Microbiology', 'Serology', 'serum', 4, 1, 200, 150, true),
-- Serology / Immunology
('ANA', 'ANA (IF)', 'Immunology', 'Autoimmune', 'serum', 24, 6, 800, 700, true),
('RF', 'Rheumatoid Factor', 'Immunology', 'Autoimmune', 'serum', 4, 1, 300, 250, true),
('ASLO', 'ASO Titre', 'Immunology', 'Autoimmune', 'serum', 4, 1, 250, 200, true),
('ANCA', 'ANCA (pANCA/cANCA)', 'Immunology', 'Autoimmune', 'serum', 48, 24, 1500, 1200, true),
-- ABG
('ABG', 'Arterial Blood Gas', 'Biochemistry', 'ABG', 'blood', 0.5, 0.15, 500, 400, true)
