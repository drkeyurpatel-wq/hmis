-- ════════════════════════════════════════════════════════════════
-- Health1 HMIS — PURE SCHEMA (no seed data)
-- Drops ALL hmis_* tables, recreates 223 tables
...
BEGIN
  ...
  END LOOP;
  FOR r IN (SELECT routine_name FROM information_schema.routines WHERE routine_schema = 'public' AND routine_name LIKE 'hmis_%') LOOP
    EXECUTE 'DROP FUNCTION IF EXISTS ' || quote_ident(r.routine_name) || ' CASCADE';
  END LOOP;
END $$;

-- ── SOURCE: sql/h1_hmis_migration.sql ──
-- ============================================================
...
-- ── SOURCE: sql/billing_enhancement.sql ──
-- ============================================================
...
-- ── SOURCE: sql/pharmacy_enhancement.sql ──
-- ============================================================
...
-- ── SOURCE: sql/ipd_clinical_migration.sql ──
-- ============================================================
...
-- ── SOURCE: sql/lims_session2_migration.sql ──
-- ============================================================
...
-- ── SOURCE: sql/lims_session3_migration.sql ──
-- ============================================================
...
-- ── SOURCE: sql/radiology_enhancement.sql ──
-- ============================================================
...
-- ── SOURCE: sql/radiology_v2_migration.sql ──
-- ============================================================
...
-- ── SOURCE: sql/appointments_patient_v2_migration.sql ──
-- ============================================================
...
-- PART 1 DONE. Run SCHEMA_PART2.sql next.
