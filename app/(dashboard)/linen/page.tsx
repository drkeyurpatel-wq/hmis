    ...
    <div className="max-w-7xl mx-auto space-y-4">
      ...
      {tab === 'inventory' && <div className="space-y-3">
        <div className="flex justify-end">
          <button onClick={() => setShowAdd(!showAdd)} className="px-3 py-1.5 bg-teal-600 text-white text-xs rounded-lg">{showAdd ? 'Cancel' : '+ Add / Update'}</button>
        </div>
        {showAdd && <div className="bg-white rounded-2xl border p-4 space-y-3">
          ...
          <button onClick={addItem} className="px-6 py-2 bg-teal-600 text-white text-sm rounded-lg">Save</button>
        </div>}
      ...
      {tab === 'exchange' && <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setShowExAdd(!showExAdd)} className="px-3 py-1.5 bg-teal-600 text-white text-xs rounded-lg">{showExAdd ? 'Cancel' : '+ Log Exchange'}</button>
        </div>
        ...
        {showExAdd && <div className="bg-white rounded-2xl border p-4 space-y-3">
          ...
          <button onClick={logExchange} className="px-6 py-2 bg-teal-600 text-white text-sm rounded-lg">Log Exchange</button>
        </div>}
