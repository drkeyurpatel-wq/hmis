...
function HandoverInner() {
  ...
  const printHandover = () => {
    ...
    <h1>Health1 Super Speciality Hospital — Shift Handover</h1>
    ...
    <p style="margin-top:24px;color:#999;font-size:10px">Generated by Health1 HMIS · This is an auto-generated handover document</p>
