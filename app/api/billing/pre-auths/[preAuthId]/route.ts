// ═══════════════════════════════════════════════════════════════════════
// src/app/api/billing/pre-auths/[preAuthId]/route.ts — GET detail
// ═══════════════════════════════════════════════════════════════════════
...
export async function GET(
  ...
  const { data, error } = await supabase
    ...
    .select(`
      *,
      billing_insurance_companies (company_name, company_code, company_type, is_cashless),
      billing_tpa_masters (tpa_name, tpa_code, settlement_tat_days)
    `)
